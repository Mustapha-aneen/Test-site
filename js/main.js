...
const datas = [
    {"title":"Python","body":"Python is a backend language "},
    {"title":"JavaScript","body":"JavaScript is a frontend language"},
    {"title":"Django","body":"Django is python web framework"},
    {"title":"React js","body":"React js is JavaScript web framework for render webpage"}
]
...
const loadToHtml = objs => {
    ...
    objs.forEach((data) => {
        doc = `
            <div class="item-box p-2 shadow-sm border-3 rounded m-2 mt-3">
